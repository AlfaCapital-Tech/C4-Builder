...
private JRE cache, `c4builder jre info` prints which Java would be used.
...
image. Relative links between artifacts of a change point to their pages, referenced files
